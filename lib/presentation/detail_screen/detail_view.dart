                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Our latest footwear collection combines style, comfort, and sustainability. Made from high-quality, eco-friendly materials like recycled rubber and vegan leather, each pair is designed to be durable while minimizing environmental impact. The collection features a wide range of options, from casual sneakers to elegant formal shoes, all boasting modern, versatile designs. Every pair is carefully crafted for a comfortable fit, ensuring you feel great whether you\'re at work, out with friends, or on the go. With attention to detail in stitching, materials, and durability, our footwear offers the perfect balance of fashion and function.',
                          style: TextStyle(
                              fontSize: 10,
                              color: Colors.black,
                              fontWeight: FontWeight.w400),
